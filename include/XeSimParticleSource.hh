#ifndef __XeSimParticleSource_H__
#define __XeSimParticleSource_H__
...
class XeSimParticleSource: public G4VPrimaryGenerator {
public:
	XeSimParticleSource();
	~XeSimParticleSource();
...
private:
	...
	XeSimParticleSourceMessenger *m_pMessenger;
