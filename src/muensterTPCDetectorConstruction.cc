...
muensterTPCDetectorConstruction::muensterTPCDetectorConstruction() {
  ...
  m_hGeometryParameters["NbPhotoDets"] = 14;
...
void muensterTPCDetectorConstruction::ConstructXenon() {
  ...
  XeSimLXeSensitiveDetector *pLXeSD = new XeSimLXeSensitiveDetector("muensterTPC/LXeSD");
...
void muensterTPCDetectorConstruction::ConstructPmtArrays() {
  ...
  XeSimPhotoDetSensitiveDetector *pPmtSD = new XeSimPhotoDetSensitiveDetector("muensterTPC/PmtSD");
