...
#include "XeSimParticleSourceMessenger.hh"

XeSimParticleSourceMessenger::XeSimParticleSourceMessenger(XeSimParticleSource *pParticleSource):
...
XeSimParticleSourceMessenger::~XeSimParticleSourceMessenger()
{
	delete m_pTypeCmd;
	delete m_pShapeCmd;
	delete m_pCenterCmd;
...
void
XeSimParticleSourceMessenger::SetNewValue(G4UIcommand * command, G4String newValues)
{
